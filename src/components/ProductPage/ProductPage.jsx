...
const ProductPage = ({ cartItems, setCartItems }) => {
  ...
  function toCart() {
    ...
    if (currentCount === 0) return alert("You can't add 0 items to your cart!");
    Object.assign(dataToCart, { count: currentCount });
    setCartItems([...cartItems, dataToCart]);
  }
